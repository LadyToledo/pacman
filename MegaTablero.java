...
public class MegaTablero extends JPanel implements ActionListener,Constantes {
...
*/
    ...
    private void drawMaze(Graphics2D g2d) { //dibujar laberinto
        ...
        for (y = 0;  y < scrsize; y += blocksize) { 
            for (x = 0; x < scrsize; x += blocksize) {
                ...
                g2d.setStroke(new BasicStroke(2)); //2
    ...
    private void initGame() { //juego de inicio
